  ...
  return (
    <View style={styles.container}>
      <Image
        ...
        style={styles.logo}
      />
      <Text style={[styles.appName, { fontFamily: 'FancyFont' }]}>
        Maid Link
      </Text>
      <ActivityIndicator size="large" color="#722620" style={styles.loader} />
    </View>
  );
};
...
const styles = StyleSheet.create({
  container: {
    ...
    alignItems: 'center',
    backgroundColor: '#f2bc94', // Solid background color
  },
  logo: {
    width: 200,
    height: 200,
