  ...
  return (
    <ScrollView contentContainerStyle={styles.container}>
      ...
      <View style={styles.inputWrapper}>
        <Ionicons name="person-outline" size={20} color="#722620" />
        <TextInput
          style={styles.input}
      ...
      <View style={styles.inputWrapper}>
        <Ionicons name="at" size={20} color="#722620" />
        <TextInput
          style={styles.input}
      ...
      <View style={styles.inputWrapper}>
        <Ionicons name="mail-outline" size={20} color="#722620" />
        <TextInput
          style={styles.input}
      ...
      <View style={styles.inputWrapper}>
        <Ionicons name="call-outline" size={20} color="#722620" />
        <TextInput
          style={styles.input}
      ...
      <View style={styles.inputWrapper}>
        <Ionicons name="lock-closed-outline" size={20} color="#722620" />
        <TextInput
          style={styles.input}
      ...
      <View style={styles.inputWrapper}>
        <Ionicons name="home-outline" size={20} color="#722620" />
        <TextInput
          style={styles.input}
