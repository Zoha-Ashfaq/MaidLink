  ...
  return (
    <ScrollView contentContainerStyle={styles.container}>
      ...
      <TouchableOpacity style={styles.backButton} onPress={handleBack}>
        <Ionicons name="arrow-back" size={24} color="#722620" />
      </TouchableOpacity>

      {/* Illustration */}
      <Image source={require('../../assets/pictures/Welcome.png')} style={styles.illustration} />
      ...
      <View style={styles.inputContainer}>
        <Ionicons name="person" size={24} color="#722620" style={styles.icon} />
        <TextInput
          style={styles.input}
      ...
      <View style={styles.inputContainer}>
        <Ionicons name="call" size={24} color="#722620" style={styles.icon} />
        <TextInput
          style={styles.input}
      ...
      <View style={styles.inputContainer}>
        <Ionicons name="location" size={24} color="#722620" style={styles.icon} />
        <TextInput
          style={styles.input}
      ...
      <View style={styles.inputContainer}>
        <Ionicons name="lock-closed" size={24} color="#722620" style={styles.icon} />
        <TextInput
          style={styles.input}
