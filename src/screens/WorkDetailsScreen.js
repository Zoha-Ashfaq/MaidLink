...
const WorkDetailsScreen = () => {
  ...
  return (
    <ScrollView contentContainerStyle={styles.container}>
      ...
      {/* Illustration */}
      <Image
        source={require('../../assets/pictures/work.png')} // Update with the correct illustration path
      ...
      <View style={styles.inputContainer}>
        <Ionicons name="briefcase-outline" size={20} color="#722620" />
        <TextInput
          style={styles.input}
      ...
      {/* Rate per Hour */}
      <View style={styles.inputContainer}>
        <Ionicons name="cash-outline" size={20} color="#722620" />
        <TextInput
          style={styles.input}
